...
DIGEST_CMD="0 5 * * 0 AGENT_JOURNAL_SESSION=1 $CLAUDE_BIN --print --dangerously-skip-permissions -p \"Use the /reflect skill with 'weekly' argument to generate this week's digest\" >> /tmp/weekly-digest.log 2>&1"
